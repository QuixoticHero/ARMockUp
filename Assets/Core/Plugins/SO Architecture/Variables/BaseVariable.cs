...
namespace ScriptableObjectArchitecture
{
    public abstract class BaseVariable : GameEventBase
    {
        ...
        public abstract bool UpdateEqualValue { get; }
    ...
    public abstract class BaseVariable<T> : BaseVariable
    {
        ...
        public override bool UpdateEqualValue { get { return _updateEqualValue; } }
        ...
        [SerializeField]
        private bool _updateEqualValue = false;
        [SerializeField]
    ...
    public abstract class BaseVariable<T, TEvent> : BaseVariable<T> where TEvent : UnityEvent<T>
    {
        ...
        public override T SetValue(T value)
        {
            ...
            if (!UpdateEqualValue ? newValue == null ? oldValue != null : !newValue.Equals(oldValue) : true)
