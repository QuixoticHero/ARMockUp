...
namespace ScriptableObjectArchitecture.Editor
{
    ...
    public class BaseVariableEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _updateEqualValue;
        ...
        private const string UPDATEEQUALVALUE_TOOLTIP = "Enable, will update with every value set";

        protected virtual void OnEnable()
        {
            _valueProperty = serializedObject.FindProperty("_value");
            _readOnly = serializedObject.FindProperty("_readOnly");
            _updateEqualValue = serializedObject.FindProperty("_updateEqualValue");
        ...
        protected void DrawReadonlyField()
        {
            ...
            EditorGUILayout.PropertyField(_updateEqualValue, new GUIContent("Update Equal Value", UPDATEEQUALVALUE_TOOLTIP));
